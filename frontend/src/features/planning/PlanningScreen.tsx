import { PlanningReadinessPanel } from "../planning-readiness/PlanningReadinessPanel";
import { usePlanningReadiness } from "../planning-readiness/usePlanningReadiness";
...
export function PlanningScreen({
  ...
  const { readiness, readinessLoading, readinessRunning, readinessError, refreshReadiness, runReadinessReview } =
    usePlanningReadiness(projectId, planning);
  ...
  return (
    <section className="screen-panel">
      ...
      <PlanningReadinessPanel
        ...
        readinessRunning={readinessRunning}
        readinessError={readinessError}
        runReadinessReview={runReadinessReview}
        agentExecutionEnabled={agentExecutionEnabled}
        agentExecutionMessage={agentExecutionMessage}
      />
