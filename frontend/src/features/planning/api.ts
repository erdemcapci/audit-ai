import { planningReadinessApi } from "../planning-readiness/api";
...
export const planningApi = {
  ...
  // Preserve the existing planning API surface for callers.
  readiness: planningReadinessApi.readiness,
  runReadinessReview: planningReadinessApi.runReadinessReview
};
